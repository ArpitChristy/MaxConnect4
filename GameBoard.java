...
public class GameBoard {
	...
	public GameBoard(int masterGame[][], int playColoum) {

		this.playBoard = new int[6][7];
		this.pieceCount = 0;
		this.playPeice = playColoum;
	...
	public void removePiece(int column) {
		...
		System.out.println("gameBoard.removePiece(). I am removing the " + "piece in column ->" + column + "<-");
		this.printGameBoard();
		// end testing
	...
	public int getThreeCount(int player) {
		...
		for (int i = 0; i < 6; i++) {
			for (int j = 0; j < 4; j++) {
				if (((this.playBoard[i][j] == player) && (this.playBoard[i][j + 1] == player)
						&& (this.playBoard[i][j + 2] == player) && (this.playBoard[i][j + 3] == 0))
						|| ((this.playBoard[i][j] == 0) && (this.playBoard[i][j + 1] == player)
								&& (this.playBoard[i][j + 2] == player) && (this.playBoard[i][j + 3] == player))
						|| ((this.playBoard[i][j] == player) && (this.playBoard[i][j + 1] == 0)
								&& (this.playBoard[i][j + 2] == player) && (this.playBoard[i][j + 3] == player))
						|| ((this.playBoard[i][j] == player) && (this.playBoard[i][j + 1] == player)
								&& (this.playBoard[i][j + 2] == 0) && (this.playBoard[i][j + 3] == player))) {
					playerScore++;
				}
			}
		}
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 7; j++) {
				if ((this.playBoard[i][j] == player) && (this.playBoard[i + 1][j] == player)
						&& (this.playBoard[i + 2][j] == player) && (this.playBoard[i + 3][j] == 0)) {
					playerScore++;
				}
			}
		}
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 4; j++) {
				if ((this.playBoard[i][j] == player) && (this.playBoard[i + 1][j + 1] == player)
						&& (this.playBoard[i + 2][j + 2] == player) && (this.playBoard[i + 3][j + 3] == 0)
						|| ((this.playBoard[i][j] == player) && (this.playBoard[i + 1][j + 1] == 0)
								&& (this.playBoard[i + 2][j + 2] == player) && (this.playBoard[i + 3][j + 3] == player))
						|| ((this.playBoard[i][j] == 0) && (this.playBoard[i + 1][j + 1] == player)
								&& (this.playBoard[i + 2][j + 2] == player) && (this.playBoard[i + 3][j + 3] == player))
						|| ((this.playBoard[i][j] == player) && (this.playBoard[i + 1][j + 1] == player)
								&& (this.playBoard[i + 2][j + 2] == 0) && (this.playBoard[i + 3][j + 3] == player))) {
					playerScore++;
				}
			}
		}
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 4; j++) {
				if (((this.playBoard[i + 3][j] == 0) && (this.playBoard[i + 2][j + 1] == player)
						&& (this.playBoard[i + 1][j + 2] == player) && (this.playBoard[i][j + 3] == player))
						|| ((this.playBoard[i + 3][j] == player) && (this.playBoard[i + 2][j + 1] == player)
								&& (this.playBoard[i + 1][j + 2] == player) && (this.playBoard[i][j + 3] == 0))
						|| ((this.playBoard[i + 3][j] == player) && (this.playBoard[i + 2][j + 1] == 0)
								&& (this.playBoard[i + 1][j + 2] == player) && (this.playBoard[i][j + 3] == player))
						|| ((this.playBoard[i + 3][j] == player) && (this.playBoard[i + 2][j + 1] == player)
								&& (this.playBoard[i + 1][j + 2] == 0) && (this.playBoard[i][j + 3] == player))) {
					playerScore++;
				}
			}
		}
	...
	public int getTwoCount(int player) {
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 7; j++) {
				if ((this.playBoard[i][j] == player) && (this.playBoard[i + 1][j] == player)
						&& (this.playBoard[i + 2][j] == 0) && (this.playBoard[i + 3][j] == 0)) {
					playerScore++;
				}
			}
		} // end verticle
